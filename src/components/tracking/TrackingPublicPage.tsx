...
interface TrackingPublicPageProps {
  language: Language;
}

// Mock public category analyses
const mockPublicAnalyses: Analysis[] = [
  {
    id: "1",
    name: "Vêtements vintage femme",
    thumbnail: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=200&h=200&fit=crop",
    status: "completed",
    createdAt: "20 déc. 2024",
    url: "https://www.vinted.fr/catalog?category_id=123",
  },
  {
    id: "2",
    name: "Sneakers homme",
    ...
    url: "https://www.vinted.fr/catalog?category_id=456",
  },
  {
    id: "3",
    name: "Sacs à main cuir",
    thumbnail: "https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=200&h=200&fit=crop",
    status: "completed",
    createdAt: "10 déc. 2024",
    url: "https://www.vinted.fr/catalog?category_id=789",
  },
];

export function TrackingPublicPage({ language }: TrackingPublicPageProps) {
  const [analyses, setAnalyses] = useState<Analysis[]>(mockPublicAnalyses);
  const [selectedAnalysisId, setSelectedAnalysisId] = useState<string>(mockPublicAnalyses[0]?.id);
